...
public class JwtAuthentiticationTokenFilter extends AbstractAuthenticationProcessingFilter {

    private AuthenticationManager authenticationManager;
    private JwtSuccessHandler jwtSuccessHandler;

    protected JwtAuthentiticationTokenFilter(String defaultFilterProcessesUrl) {
        super("/api/**");
    }
    @Override
